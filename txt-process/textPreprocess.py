...
if __name__=='__main__':
	txt1=TextProcess.wordseg("./rongyao3c.txt")
	txt2=TextProcess.santencebreak(txt1,)
	txt3=TextProcess.stopwordRM(txt2)
	txt4=TextProcess.wordfilter(txt3,)
	txt5=TextProcess.array2str(txt4)
	TextProcess.savefile(txt5,"./rongyao3c_result.txt")